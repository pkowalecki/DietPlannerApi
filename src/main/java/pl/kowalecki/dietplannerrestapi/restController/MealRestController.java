...
public class MealRestController {
    ...
    @PostMapping( "/addMeal")
    public ResponseEntity<ResponseDTO> addMeal(@RequestBody AddMealRequestDTO newMeal, HttpSession session, HttpServletResponse response){
        System.out.println("Sesjon: " + session.getAttribute("user"));
        System.out.println("niu mil: " + newMeal);
//        mealServiceImpl.addMeal(userId, newMeal);
//        response.addHeader();
